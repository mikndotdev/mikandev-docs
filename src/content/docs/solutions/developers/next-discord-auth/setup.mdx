...
<PackageManagers
  type="install"
  pkg="@mikandev/next-discord-auth"
...
<Aside type="danger">
  Do **NOT** put your secrets directly in this file! Use environment variables instead. You can use
  a `.env` file to store them locally, and set them in your deployment environment.
</Aside>
