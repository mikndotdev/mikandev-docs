...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to MikanDev, Osaka.
...
- __Website__ refers to MikanDev, accessible from [https://mikn.dev/](https://mikn.dev/)
