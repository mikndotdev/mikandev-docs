...
- **Affiliate** means an entity that controls, is controlled by or is under common control with a party, where "control" means a strategic partnership with MikanDev.

- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to MikanDev, Osaka.
...
- **Website** refers to MikanDev, accessible from [https://mikn.dev/](https://mikn.dev/)
